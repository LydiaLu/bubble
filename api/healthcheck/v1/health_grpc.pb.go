...
const (
	HealthCheckService_HealthCheck_FullMethodName = "/healthcheck.v1.HealthCheckService/HealthCheck"
)
...
func (c *healthCheckServiceClient) HealthCheck(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
func (UnimplementedHealthCheckServiceServer) HealthCheck(context.Context, *emptypb.Empty) (*HealthCheckResponse, error) {
...
var HealthCheckService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "healthcheck/v1/health.proto",
}
